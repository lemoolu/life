//声明Req为全局变量 代码最底部定义请求
//该文件需要同步加载interface.json 当界面不需要动态请求数据时，请勿加载
//依赖jq
...
(function(){
    ...
    Req.Activity = ModelProxy.create( 'Activity.*' );
    Req.User = ModelProxy.create( 'User.*' );
    Req.Admin = ModelProxy.create( 'Admin.*' );
